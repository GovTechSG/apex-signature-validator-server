const constants = {
  ...
  strings: {
    signatureUrl:
      "Apex API domains (api.gov.sg) need to have subdomains .i (intranet gateway) or .e (internet gateway) inserted for signing."
  },
  requestBodyTypes: [
    "none",
    "application/json",
...
export default {
  ...
  main: {
    ...
    providerGateway: [
      constants.gatewayZones.internet,
      constants.gatewayZones.intranet
    ],
    authLevels: [1, 2],
    ...
    errorMessages: {
      ...
      pemSecretInvalid:
        "Please verify that both pem string and secret are correct",
      httpRequestError:
        "Error contacting backend; please check that it is running.",
      signatureSecretInvalid:
        "Error obtaining signature; please double-check L1 app secret or L2 private key/passphrase.",
      httpRequestFullError:
        "Error encountered while making the request. Please refer to the readme at https://github.com/GovTechSG/apex-signature-validator for possible causes."
    }
  },
  sign: {
